...
class StartScene {
    ...
    createPlanet(opts, scene) {
        ...
        planet.orbitAnimationOvserver = this.createAndStartOrbitAnimation(planet, scene);
    ...
    createAndStartOrbitAnimation(planet, scene) {
        ...
        let preRenderObsv = scene.onBeforeRenderObservable.add(() => {
